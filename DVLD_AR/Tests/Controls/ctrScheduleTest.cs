...
namespace DVLD_AR.Tests.Controls
{
    public partial class ctrScheduleTest : UserControl
    {
        ...
        public void LoadInfo( int LocalDrivingLicenseApplicationID, int AppointmentID = -1 )
        {
            ...
            {
                MessageBox.Show( "خطأ : لايوجد طلب بهذا الرقم", "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error );
        ...
        private bool _LoadTestAppointmentData()
        {
            ...
            if ( DateTime.Compare( DateTime.Now, _TestAppointment.AppointmentDate ) < 0 )
                ...
                dtpAppDate.MinDate = _TestAppointment.AppointmentDate;

            dtpAppDate.Value = _TestAppointment.AppointmentDate;
        ...
        private bool _HandleAppointmentLockedConstraint()
        {
            ...
            if ( _TestAppointment.IsLocked )
            {
                ...
                lblUserMessage.Text = "الموعد مغلق.. هذاالشخص لديه موعد مسبق لهذا الإختبار";
                dtpAppDate.Enabled = false;
                btnSave.Enabled = false;
                return false;
        ...
        private bool _HandlePrviousTestConstraint()
        {
            ...
            switch ( TestTypeID )
            {
                ...
                case clsTestType.enTestType.WrittenTest:
                    ...
                    {
                        lblUserMessage.Text = "لم تتم الجدولة.. يجب إجتياز إختبار النظر أولا";
                        lblUserMessage.Visible = true;
                        btnSave.Enabled = false;
                        dtpAppDate.Enabled = false;
                        return false;
                ...
                case clsTestType.enTestType.StreetTest:
                    ...
                    {
                        lblUserMessage.Text = "لم تتم الجدولة.. يجب إجتياز الإختبار الكتابي أولا";
                        lblUserMessage.Visible = true;
                        btnSave.Enabled = false;
                        dtpAppDate.Enabled = false;
                        return false;
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if ( _Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule )
            {
                ...
                if ( !Application.Save() )
                {
                    ...
                    MessageBox.Show( "خطأ في عمليُة إنشاء الطلب", "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error );
                    return false;
                }
        ...
        private void btnSave_Click( object sender, EventArgs e )
        {
            ...
            {
                _Mode = enMode.Update;
                MessageBox.Show( "تمت عملية الحفظ بنجاح", "تم الحفظ", MessageBoxButtons.OK, MessageBoxIcon.Information );

            }
            else
                MessageBox.Show( "لم تتم عملية الحفظ", "خطأ", MessageBoxButtons.OK, MessageBoxIcon.Error );
