...
namespace DVLD_DataAccess
{
    public class clsLicenseClassData
    {
           ...
           ref byte DefaultValidityLength, ref float ClassFees )
        {
            ...
            {
                //Console.WriteLine("Error: " + ex.Message);
                throw new Exception( "An error occurred while getting the License Class information" + ex.Message, ex );
            }
            finally
            {
                connection.Close();
        ...
        public static DataTable GetAllLicenseClasses()
        {
            ...
            {
                // Console.WriteLine("Error: " + ex.Message);
                throw new Exception( "An error occurred while getting the list of License Classes", ex );
            }
            finally
            {
                connection.Close();
