...
namespace DVLD_DataAccess
{
    public class clsTestTypeData
    {
        ...
        public static DataTable GetAllTestTypes()
        {
            ...
            string query = "SELECT TestTypeID as [رقم المعرُف], TestTypeTitle as [إسم الإختبار], TestTypeDescription as [وصف الإختبار], TestTypeFees as [رسوم الإختبار] FROM TestTypes order by TestTypeID";
