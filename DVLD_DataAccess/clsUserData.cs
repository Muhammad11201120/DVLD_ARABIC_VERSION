...
namespace DVLD_DataAccess
{
    public class clsUserData
    {
        ...
        public static DataTable GetAllUsers()
        {
            ...
            string query = @"SELECT  Users.UserID as [معرٌف المستخدم], Users.PersonID as [المعرٌف الشخصي],
                            TRIM(People.FirstName)+ ' ' + TRIM(People.SecondName) + ' ' + ISNULL( TRIM(People.ThirdName),'') +' ' +TRIM(People.LastName) as [الإسم الكامل],
                             Users.UserName as [إسم المستخدم], Users.IsActive as [حالة النشاط]
